...
export const OFFERS: Offer[] = [
  { id: 'skekraft', name: 'Skellefteå Kraft', logo: '/images/suppliers/skekraft.svg', logoWidth: 112, kind: 'Rörligt elpris', markup: 6, monthlyFee: 49, feeFreeMonths: 12, comparePrice: 72.76, notice: '1 månads uppsägningstid' },
  { id: 'tibber', name: 'Tibber', logo: '/images/suppliers/tibber-crop.svg', logoWidth: 96, kind: 'Kvartspris', markup: 8, monthlyFee: 49, feeFreeMonths: 0, comparePrice: 78.66, notice: '1 månads uppsägningstid', creditCheck: true },
  { id: 'fortum', name: 'Fortum', logo: '/images/suppliers/fortum.svg', logoWidth: 100, kind: 'Rörligt elpris', markup: 7.5, monthlyFee: 69, feeFreeMonths: 0, comparePrice: 74.9, notice: '1 månads uppsägningstid' },
  { id: 'vattenfall', name: 'Vattenfall', logo: '/images/suppliers/vattenfall.svg', logoWidth: 110, kind: 'Rörligt elpris', markup: 9, monthlyFee: 55, feeFreeMonths: 0, comparePrice: 80.05, notice: '1 månads uppsägningstid' },
]
