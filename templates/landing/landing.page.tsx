        ...
        <section className="w-screen flex justify-center bg-[var(--color-secondary-main)] border-t border-white/10">
          <div className="w-full px-4 md:px-8 max-w-[1232px] py-6">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
              ...
              <a href="tel:+46812008822" className="flex items-center gap-2 !text-white hover:!text-[var(--color-primary-main)] transition-colors">
                <span className="w-7 h-7 rounded-full bg-[var(--color-primary-main)]/20 flex items-center justify-center shrink-0">
              ...
              <a href="mailto:hej@flyttsmart.se" className="flex items-center gap-2 !text-white hover:!text-[var(--color-primary-main)] transition-colors">
                <span className="w-7 h-7 rounded-full bg-[var(--color-primary-main)]/20 flex items-center justify-center shrink-0">
                  <svg className="w-3.5 h-3.5 text-[var(--color-primary-main)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.75}>
